...
def detect_and_recognize_faces_with_mesh(image, face_mesh, known_faces_landmarks):
    recognized_faces = []
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            for name, known_face_landmarks in known_faces_landmarks.items():
                ...
                for i in range(len(face_landmarks.landmark)):
                    ...
                    known_x = known_face_landmarks.landmark[i].x
                    known_y = known_face_landmarks.landmark[i].y
                    detected_x = face_landmarks.landmark[i].x
                    detected_y = face_landmarks.landmark[i].y
                    # Calculate Euclidean distance between the landmarks
