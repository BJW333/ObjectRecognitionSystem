...
known_faces_folder = "/Users/blakeweiss/Desktop/ObjectRecognitionARGUS/knownfaces"
...
def detect_and_recognize_faces_with_mesh(image, face_mesh, known_faces_landmarks, confidence_threshold=0.5): #work on the confidence threshold
    recognized_faces = []
    h, w, _ = image.shape
